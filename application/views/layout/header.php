...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <img src="<?php echo base_url('/assets/images/bdi.png') ?>" alt="" width="30" height="24" class="d-inline-block align-text-top">
            <a class="navbar-brand" href="#">Klinik Fitria</a>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href=" <?php echo base_url('pengadaan'); ?>">Tindakan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href=" <?php echo base_url('pengadaan'); ?>">Obat</a>
                    </li>
